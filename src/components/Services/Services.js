    ...
    render() {
        return (
            <div>
                ...
                <h4 id="supporting-tag" style={{ flexBasis: '100%', marginLeft: '1.5em', marginRight: '1.5em', textAlign: 'center', fontFamily: 'Maven Pro' }}>Explore how <strong style={{color:'dodgerblue'}}>BornTec</strong> can help you <strong style={{color:'dodgerblue'}}>accelerate</strong> in todays rapidly <strong style={{color:'dodgerblue'}}>changing world</strong></h4>
            </div>
            <br/>
