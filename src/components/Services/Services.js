        ...
        return (
            <div >
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30)" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4" style={{ color: 'White' }}>Managed Hosting <strong style={{ color: primaryColor1 }}>Services</strong></h1>
                        <h5 style={{ color: primaryColor1 }}>Trading Technologies</h5>
                        ...
                        <h5 style={{ color: primaryColor1 }}>Itiviti</h5>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30)" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4" style={{ color: primaryColor2 }}><strong style={{ color: "white" }}>Direct Market</strong> Access</h1>
                        <h5 style={{ color: primaryColor2 }}>Closest Proximity to Exchange Matching Engine</h5>
                        ...
                        <h5 style={{ color: primaryColor2 }}>Global Colocation Facilities</h5>
                        ...
                        <h5 style={{ color: primaryColor2 }}>Execution Control</h5>
                        ...
                        <h5 style={{ color: primaryColor2 }}>Institutional Focus</h5>
                        <p class="lead" style={{ color: "white" }}>Born services professional traders only, allowing for higher level of support.</p>
                        <h5 style={{ color: primaryColor2 }}>Physical and Network Security</h5>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30)" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4" style={{ color: 'white' }}>Low Latency <strong style={{ color: primaryColor1 }}>Trading</strong></h1>
                        <h5 style={{ color: primaryColor1 }}>State of the Art Architecture</h5>
                        ...
                        <h5 style={{ color: primaryColor1 }}>Ultra Low-latency Infrastructure</h5>
                        ...
                        <h5 style={{ color: primaryColor1 }}>Network Infrastructure</h5>
                        ...
                        <h5 style={{ color: primaryColor1 }}>Microwave Telecommunication Services</h5>
