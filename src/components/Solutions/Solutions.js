        ...
        return (
            <div >
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30)" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{color:"OrangeRed"}}>Cross Check</h1>
                    ...
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                            <h5 style={{color: "OrangeRed"}}>Automated Trading and DEA Management</h5>
                            <ul>
                        ...
                        <div>
                            <h5 style={{color: "OrangeRed"}}>Position Monitoring and Alerting</h5>
                            <ul>
                        ...
                        <div>
                            <h5 style={{color: "OrangeRed"}}>Transaction Reporting for MiFID II</h5>
                            <ul>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    ...
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                            <h5 style={{color:'OrangeRed'}}>Client-Broker FIX Routing for Care Orders</h5>
                            <ul>
