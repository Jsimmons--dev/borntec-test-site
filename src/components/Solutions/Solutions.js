        ...
        return (
            <div >
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30)" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: theme.primaryColor1 }}>Cross Check</h1>
                        <p align='Left'>Compliance and Monitoring System, MiFID II, CFTC and MAR</p>
                    </div>
                    <hr />
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: theme.primaryColor2 }}>TraC</h1>
                        <p align='Left' >Real-Time Trade Blotter Across All Vendors/Exchanges</p>
                    </div>
                    <hr />
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: theme.primaryColor1 }}>CORE</h1>
                        <p align='Left'>Care Order STP Between Clients and Brokers</p>
                    </div>
                    <hr />
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: theme.primaryColor2 }}>JetConnect</h1>
                        <p align='Left'>SaaS Real-Time Trade Flow Distribution</p>
                    </div>
                    <hr />
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
