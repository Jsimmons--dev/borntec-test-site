        ...
        return (
            <div >
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30)" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: primaryColor1 }}>Cross Check</h1>
                    ...
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                            <h5 style={{ color: primaryColor1 }}>Automated Trading and DEA Management</h5>
                            <ul>
                        ...
                        <div>
                            <h5 style={{ color: primaryColor1 }}>Position Monitoring and Alerting</h5>
                            <ul>
                        ...
                        <div>
                            <h5 style={{ color: primaryColor1 }}>Transaction Reporting for MiFID II</h5>
                            <ul>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: primaryColor2 }}>TraC</h1>
                        <p align='Left' style={{ color: "white" }}>Real-Time Trade Blotter Across All Vendors/Exchanges</p>
                    </div>
                    <hr />
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                            <h5 style={{ color: primaryColor2 }}>Cost Effective Terminals for Risk & Compliance</h5>
                            <ul>
                                <li style={{ color: "White" }}>TraC is intuitive and easy to use for non-trading personnel</li>
                            </ul>
                        </div>
                        <div>
                            <h5 style={{ color: primaryColor2 }}>Single Screen, Rapid Access to All Order Flow</h5>
                            <ul>
                        ...
                        <div >
                            <h5 style={{ color: primaryColor2 }}>Automated Trading and DEA Management</h5>
                            <ul>
                                <li style={{ color: "White" }}>Monitor messaging velocity in realtime</li>
                                <li style={{ color: "White" }}>Visualize by exchange, trade session, user, algo ID & more</li>
                                <li style={{ color: "White" }}>Monitor for rejections and limit band breaches</li>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: primaryColor1 }}>CORE</h1>
                        <p align='Left' style={{ color: 'White' }}>Care Order STP Between Clients and Brokers</p>
                    </div>
                    <hr />
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                            <h5 style={{ color: primaryColor1 }}>Client-Broker FIX Routing for Care Orders</h5>
                            <ul>
                ...
                <div style={{ backgroundColor: "rgb(30, 30, 30" }} class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 align='Left' class="display-4" style={{ color: primaryColor2 }}>JetConnect</h1>
                        <p align='Left' style={{ color: 'white' }}>SaaS Real-Time Trade Flow Distribution</p>
                    </div>
                    <hr />
                    <div className={'container-fluid'} style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around' }}>
                        <div>
                            <h5 style={{ color: primaryColor2 }}>Flexibility</h5>
                            <ul>
                        ...
                        <div>
                            <h5 style={{ color: primaryColor2 }}>Consolidation</h5>
                            <ul>
