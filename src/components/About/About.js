    ...
    render() {
        return (
            <div>
                ...
                <h1 id="main-tag" style={{ fontFamily: 'Maven Pro' }} className="display-5">About BornTec</h1>
                <h4 id="supporting-tag" style={{ flexBasis: '100%', marginLeft: '1.5em', marginRight: '1.5em', textAlign: 'center', fontFamily: 'Maven Pro' }}> Learn about us and Explore our site</h4>
            </div>
            <br/>
