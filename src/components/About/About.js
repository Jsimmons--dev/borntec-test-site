    ...
    render() {
        return (
            <div>
                ...
                <h1 id="main-tag" style={{ fontFamily: 'Maven Pro' }} className="display-5">About <strong style={{color: 'dodgerblue'}}>BornTec</strong></h1>
                <h4 id="supporting-tag" style={{ flexBasis: '100%', marginLeft: '1.5em', marginRight: '1.5em', textAlign: 'center', fontFamily: 'Maven Pro' }}> Learn about us and <strong style={{color: 'dodgerblue'}}>Explore </strong>our site</h4>
            </div>
            <br/>
