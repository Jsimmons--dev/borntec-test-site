    ...
    render() {
        return (
            <div className="container-fluid">
                ...
                <br />
                <p align="center"><strong > Our software solutions encompass <strong style={{ color: theme.primaryColor2 }}>MiFID II compliance</strong>, including providing realtime <strong style={{ color: theme.primaryColor2 }}>monitoring and alerting</strong> solutions for algorithmic and DEA trading for <strong style={{ color: theme.primaryColor2 }}>RTS 6</strong>, transaction reporting and others </strong></p>
                <br />
                <br />
                <br />
                <br />
