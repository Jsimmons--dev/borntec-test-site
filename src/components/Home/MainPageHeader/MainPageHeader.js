...
=======
            <div id='main-page-header' className="container-fluid jumbotron-fluid" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexWrap:'wrap', 'alignContent':'center', backgroundImage:'url(./assets/servers.jpg)', color: "coral" }}  >
>>>>>>> 23c7e3074550a920f38ab204a272f1f739eec9ee
